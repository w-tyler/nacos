...
public class PropertyUtil {
    ...
    public void init() {
        try {
            ...
            setStandalonePostgreSql(getString("spring.datasource.platform", "").equals("postgresql"));
    ...
    public static boolean isStandaloneUsePostgreSql() {
        return standaloneUsePostgreSql;
    }
    ...
    public static void setStandalonePostgreSql(boolean standaloneUsePostgreSql) {
